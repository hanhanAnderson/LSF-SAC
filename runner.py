...
class Runner:
        ...
        # while time_steps < self.args.n_steps:
            ...
            if time_steps // self.args.evaluate_cycle > evaluate_steps:
                if evaluate_steps % 30 == 0:
                    ...
                    win_rate, episode_reward = self.evaluate()
                # win_rate, episode_reward = self.evaluate()
                print('win_rate is {} at {} eva_cycle'.format(win_rate, evaluate_steps))
    ...
    def evaluate(self,save_replay = False):
        win_number = 0
        episode_rewards = 0
        for epoch in range(self.args.evaluate_epoch):
            _, episode_reward, win_tag, _ = self.rolloutWorker.generate_episode(epoch, evaluate=True,save_replay = save_replay)
