...
def get_common_args():
    ...
    parser.add_argument('--map', type=str, default='3s5z', help='the map of the game')
    ...
    parser.add_argument('--n_steps', type=int, default=4000000, help='total time steps')
...
def get_mixer_args(args):
    # Comm
    args.comm_embed_dim = 3
    args.comm_beta= 0.001
    args.comm_entropy_beta= 1e-6
    args.alpha = 1.0
    args.is_comm_beta_decay = False
    args.comm_beta_start_decay= 20000000
    args.comm_beta_target= 1e-2
    args.comm_beta_end_decay= 50000000

    args.is_comm_entropy_beta_decay= False
    args.comm_entropy_beta_start_decay= 20000000
    args.comm_entropy_beta_target= 1e-4
    args.comm_entropy_beta_end_decay= 50000000
