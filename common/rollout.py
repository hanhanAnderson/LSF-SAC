...
class RolloutWorker:
    ...
    def generate_episode(self, episode_num=None, evaluate=False,save_replay = False):
        ...
        if evaluate and episode_num == self.args.evaluate_epoch - 1 and self.args.replay_dir != '' and save_replay:
            print("saving replay..")
